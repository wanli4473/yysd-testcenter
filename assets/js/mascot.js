...
(function () {
  ...
  var ONBOARD_STEPS = [
    "你好，我是思达，你的错题本陪练。",
    "单词区背单词、练习区精听长难句、真题区剑桥真题——点我都能给建议。",
  ...
  var TIPS = {
    ...
    mock: [
      "真题区剑桥雅思听力阅读支持计时，尽量按真考节奏。",
      "阅读题可高亮、做笔记，和机考习惯保持一致。",
      "交卷后 Band 和成绩会记在「我的成绩」。",
      "同一套题可以二刷，对比两次得分看进步。",
      "除了雅思，A-Level / AP / 托福 / SAT 真题也在真题区。"
    ],
    vocab: {
      gaozhong: [
  ...
  function idleLine() {
    ...
    if (ctx.page === "exam") {
      if (ctx.zone === "study") {
        ...
        return pick(["词汇练习别赶，拼写和释义都要稳。", "单词区进度会保存，做完记得看错题本。"]);
      }
