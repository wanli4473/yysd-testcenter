...
["vocab.html", "vocab-lesson.html", "wrong-words.html", "zone.html", "word-realm.html", "diagnostic-report.html"].forEach(function (f) {
...
must(diag.indexOf("开始首次能力测试") >= 0, "gate intro CTA");
...
must(report.indexOf("vocab.html?book=") >= 0, "report CTA to recommended book");
...
must(vocab.indexOf("YYSD_DIAG_GATE") >= 0 && vocab.indexOf("bootVocab") >= 0, "vocab.js gated boot");
...
console.log("OK diag gate smoke (" + [
  "gate", "api", "html", "diagnostic", "report", "zone", "vocab"
].join(", ") + ")");
