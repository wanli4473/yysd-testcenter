...
console.assert(html.indexOf("exam-cdt.js?v=20260801rev1") >= 0, "exam.html cache bump for exam-cdt");
console.assert(html.indexOf("exam-cdt.css?v=20260801rev1") >= 0, "exam.html cache bump for exam-cdt.css");
